/**\file */
#ifndef SLIC_DECLARATIONS_SimpleMV1_H
#define SLIC_DECLARATIONS_SimpleMV1_H
#include "MaxSLiCInterface.h"
#ifdef __cplusplus
extern "C" {
#endif /* __cplusplus */

int SimpleMV1_has_errors(void);
const char* SimpleMV1_get_errors(void);
#define SimpleMV1_M (4)
 ...
 * 
 * \param [in] ticks_SimpleMV1Kernel The number of ticks for which kernel "SimpleMV1Kernel" will run.
 ...
 */
void SimpleMV1(
	uint64_t ticks_SimpleMV1Kernel,
 ...
 */
typedef struct { 
	uint64_t ticks_SimpleMV1Kernel; /**<  [in] The number of ticks for which kernel "SimpleMV1Kernel" will run. */
...
void SimpleMV1_run(
	max_engine_t *engine,
	SimpleMV1_actions_t *interface_actions);
 ...
 */
max_run_t *SimpleMV1_run_nonblock(
	max_engine_t *engine,
	SimpleMV1_actions_t *interface_actions);
 ...
 */
void SimpleMV1_run_group(max_group_t *group, SimpleMV1_actions_t *interface_actions);
 ...
 * \return A handle on the execution status of the actions, or NULL in case of error.
 */
max_run_t *SimpleMV1_run_group_nonblock(max_group_t *group, SimpleMV1_actions_t *interface_actions);
 ...
 */
void SimpleMV1_run_array(max_engarray_t *engarray, SimpleMV1_actions_t *interface_actions[]);
 ...
 * \return A handle on the execution status of the actions, or NULL in case of error.
 */
max_run_t *SimpleMV1_run_array_nonblock(max_engarray_t *engarray, SimpleMV1_actions_t *interface_actions[]);
 ...
 */
max_actions_t* SimpleMV1_convert(max_file_t *maxfile, SimpleMV1_actions_t *interface_actions);

/**
 * \brief Initialise a maxfile.
 */
max_file_t* SimpleMV1_init(void);
#ifdef __cplusplus
}
#endif /* __cplusplus */
#endif /* SLIC_DECLARATIONS_SimpleMV1_H */
