/**\file */
#ifndef SLIC_DECLARATIONS_SimpleMV3_H
#define SLIC_DECLARATIONS_SimpleMV3_H
#include "MaxSLiCInterface.h"
#ifdef __cplusplus
extern "C" {
#endif /* __cplusplus */
#define SimpleMV3_M (4)
 ...
 * 
 * \param [in] ticks_SimpleMV3Kernel The number of ticks for which kernel "SimpleMV3Kernel" will run.
 ...
 */
void SimpleMV3(
	uint64_t ticks_SimpleMV3Kernel,
 ...
 */
typedef struct { 
	uint64_t ticks_SimpleMV3Kernel; /**<  [in] The number of ticks for which kernel "SimpleMV3Kernel" will run. */
...
void SimpleMV3_run(
	max_engine_t *engine,
	SimpleMV3_actions_t *interface_actions);
 ...
 */
max_run_t *SimpleMV3_run_nonblock(
	max_engine_t *engine,
	SimpleMV3_actions_t *interface_actions);
 ...
 */
void SimpleMV3_run_group(max_group_t *group, SimpleMV3_actions_t *interface_actions);
 ...
 * \return A handle on the execution status of the actions, or NULL in case of error.
 */
max_run_t *SimpleMV3_run_group_nonblock(max_group_t *group, SimpleMV3_actions_t *interface_actions);
 ...
 */
void SimpleMV3_run_array(max_engarray_t *engarray, SimpleMV3_actions_t *interface_actions[]);
 ...
 * \return A handle on the execution status of the actions, or NULL in case of error.
 */
max_run_t *SimpleMV3_run_array_nonblock(max_engarray_t *engarray, SimpleMV3_actions_t *interface_actions[]);
 ...
 */
max_actions_t* SimpleMV3_convert(max_file_t *maxfile, SimpleMV3_actions_t *interface_actions);

/**
 * \brief Initialise a maxfile.
 */
max_file_t* SimpleMV3_init(void);
#ifdef __cplusplus
}
#endif /* __cplusplus */
#endif /* SLIC_DECLARATIONS_SimpleMV3_H */
