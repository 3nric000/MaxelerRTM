...
void SimpleMV4CPU(int size, int32_t *dataIn, int32_t *dataOut)
{
	for (int i = 0; i < size; i++)
...
int main()
{
	...
	int32_t *dataIn[SimpleMV4_M] , *dataOut[SimpleMV4_M];
	...
	for (int i = 0; i < SimpleMV4_M; i++) {
		SimpleMV4CPU(size, dataIn[i], expected);
