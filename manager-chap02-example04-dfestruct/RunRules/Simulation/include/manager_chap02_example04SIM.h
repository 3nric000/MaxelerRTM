/**\file */
#ifndef SLIC_DECLARATIONS_manager_chap02_example04SIM_H
#define SLIC_DECLARATIONS_manager_chap02_example04SIM_H
 ...
 * 
 * \param [in] ticks_DFEStructKernel Scalar parameter
 * \param [in] inscalar_DFEStructKernel_totalBursts Scalar parameter
 * \param [in] inscalar_DFEStructKernel_wordsPerBurst Scalar parameter
 ...
 */
void manager_chap02_example04SIM(
	uint64_t ticks_DFEStructKernel,
	uint64_t inscalar_DFEStructKernel_totalBursts,
	uint64_t inscalar_DFEStructKernel_wordsPerBurst,
 ...
 */
typedef struct { 
	uint64_t ticks_DFEStructKernel; /**<  [in] Scalar parameter */
	uint64_t inscalar_DFEStructKernel_totalBursts; /**<  [in] Scalar parameter */
	uint64_t inscalar_DFEStructKernel_wordsPerBurst; /**<  [in] Scalar parameter */
...
} manager_chap02_example04SIM_actions_t;
 ...
 */
void manager_chap02_example04SIM_run(
	max_engine_t *engine,
	manager_chap02_example04SIM_actions_t *interface_actions);
 ...
 */
void manager_chap02_example04SIM_run_group(max_group_t *group, manager_chap02_example04SIM_actions_t *interface_actions);
 ...
 */
void manager_chap02_example04SIM_run_array(max_engarray_t *engarray, manager_chap02_example04SIM_actions_t *interface_actions[]);

max_actions_t* manager_chap02_example04SIM_convert(max_file_t *maxfile, manager_chap02_example04SIM_actions_t *interface_actions);
 ...
 */
void manager_chap02_example04SIM_debug(const char *debug_directory);

/**
 * \brief Initialise a maxfile.
 */
max_file_t* manager_chap02_example04SIM_init(void);
#ifdef __cplusplus
}
#endif /* __cplusplus */
#endif /* SLIC_DECLARATIONS_manager_chap02_example04SIM_H */
